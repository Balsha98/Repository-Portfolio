...
const PROJECTS = [
    {
        ...
        description: "A real-time analytics dashboard handling 100k+ data points with WebSocket streaming, custom D3 charts, and a design system used by 3 product teams.",
        tech: ["React", "JavaScript", "D3.js", "WebSockets", "Tailwind"],
        featured: true,
        visual: "PULSE",
    },
    {
        ...
        description: "60+ accessible, tested components with Storybook docs and automated visual regression. Reduced dev time by 40%.",
        tech: ["React", "Storybook", "Jest", "ARIA"],
    },
    {
        tag: "Fintech — Web App",
        title: "Ledger Budgeting App",
        description: "A personal finance PWA with offline support, transaction sync, and chart-driven insights. 4.8★ on Product Hunt.",
